...
const portfolioItems = portfolioData.slice(140, 143);
          ...
          <div className="row mt-60">
            <div className="col-xl-12">
              <div className="tpproject__menu text-center filter-button-group mb-40">
                ...
                <button className={active === 'WEB DESIGN' ? 'active' : ''} onClick={() => handleFilterItems('Frontend')}> WEB DESIGN <span className="count-number">2</span> </button>
                <button className={active === 'WEBSITE DESIGN' ? 'active' : ''} onClick={() => handleFilterItems('Backend')}>WEBSITE DESIGN <span className="count-number">2</span> </button>
